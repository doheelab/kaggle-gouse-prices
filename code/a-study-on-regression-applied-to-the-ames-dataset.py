...
train["SimplPoolQC"] = train.PoolQC.replace({1: 1, 2: 1, 3: 2, 4: 2})  # average  # good
train["SimplGarageCond"] = train.GarageCond.replace(
    {1: 1, 2: 1, 3: 1, 4: 2, 5: 2}  # bad  # average  # good
)
...
train["SimplFunctional"] = train.Functional.replace(
    {1: 1, 2: 1, 3: 2, 4: 2, 5: 3, 6: 3, 7: 3, 8: 4}  # bad  # major  # minor  # typical
)
...
train["SimplBsmtFinType1"] = train.BsmtFinType1.replace(
    {1: 1, 2: 1, 3: 1, 4: 2, 5: 2, 6: 2}  # unfinished  # rec room  # living quarters
)
...
# Plot residuals
plt.scatter(
    y_train_rdg, y_train_rdg - y_train, c="blue", marker="s", label="Training data"
)
plt.scatter(
    y_test_rdg, y_test_rdg - y_test, c="lightgreen", marker="s", label="Validation data"
)
...
# Plot residuals
plt.scatter(
    y_train_las, y_train_las - y_train, c="blue", marker="s", label="Training data"
)
plt.scatter(
    y_test_las, y_test_las - y_test, c="lightgreen", marker="s", label="Validation data"
)
...
# Plot residuals
plt.scatter(
    y_train_ela, y_train_ela - y_train, c="blue", marker="s", label="Training data"
)
plt.scatter(
    y_test_ela, y_test_ela - y_test, c="lightgreen", marker="s", label="Validation data"
)
